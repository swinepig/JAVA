...
public class BaseSection {
	...
	public BaseSection(String recordLength, String segmentIdentifier,
			String financialOrganizationCode, String bussinessType,
			String accountType, String operationNumber,
			String originationPlace, String dateOpened, String matureDate,
			String currency, String creditLimit, String sharedCreditLimit,
			String highestCredit, String guaranteeType, String termsFrequency,
			String termsDuration, String monthsLeftforTermsDuration,
			String billingDate, String dateOfLastPayment,
			String scheduledMonthlyPaymentAmount, String actualPaymentAmount,
			String balance, String delinquencyTerm, String amountPastDue,
			String noRepayLoanPrincipal31_60, String noRepayLoanPrincipal61_90,
			String noRepayLoanPrincipal91_180,
			String noRepayLoanPrincipalOver180, String delinquencyCounts,
			String highestDelinquencyTerm,
			String fiveCategoryAssetsClassification, String accountStatus,
			String twentyFourMonthsPaymentStatus,
			String overdraftAmountOver180Days, String idIndicator, String name,
